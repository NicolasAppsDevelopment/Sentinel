...
static esp_err_t get_status_handler(httpd_req_t *req) {
  ...
  String response = "{\"rssi\":" + String(WiFi.RSSI()) + "}";
  return httpd_resp_send(req, response.c_str(), response.length());
}

static esp_err_t status_cam_handler(httpd_req_t *req) {
...
void startCameraServer() {
  ...
  httpd_uri_t status_cam_uri = {
    .uri = "/status_cam",
    .method = HTTP_GET,
    .handler = status_cam_handler,
    .user_ctx = NULL
  ...
  if (httpd_start(&camera_httpd, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(camera_httpd, &status_cam_uri);
    httpd_register_uri_handler(camera_httpd, &get_status_uri);
